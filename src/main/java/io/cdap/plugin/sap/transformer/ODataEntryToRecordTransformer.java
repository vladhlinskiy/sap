...
public class ODataEntryToRecordTransformer {
  ...
  private StructuredRecord extractStream(StreamProperty streamProperty, Schema schema) {
    return StructuredRecord.builder(schema)
      .set("mediaEtag", streamProperty.getMediaEtag())
      .set("mediaContentType", streamProperty.getMediaContentType())
      .set("mediaReadLink", streamProperty.getMediaReadLink())
      .set("mediaEditLink", streamProperty.getMediaEditLink())
      .build();
  }
  ...
  private StructuredRecord extractGeospatialCollectionRecord(String fieldName, GeospatialCollection collection,
    ...
    return StructuredRecord.builder(schema)
      ...
      .set("points", points)
      .set("lineStrings", lineStrings)
      .set("polygons", polygons)
      .set("multiPoints", multiPoints)
      .set("multiLineStrings", multiLineStrings)
      .set("multiPolygons", multiPolygons)
      .build();
  }
