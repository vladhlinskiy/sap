...
public class SapODataSource extends BatchSource<NullWritable, ODataEntity, StructuredRecord> {
  ...
  private Schema streamSchema(PropertyMetadata propertyMetadata) {
    return Schema.recordOf(propertyMetadata.getName() + "-stream-record",
                           Schema.Field.of("mediaEtag", Schema.nullableOf(Schema.of(Schema.Type.STRING))),
                           Schema.Field.of("mediaContentType", Schema.nullableOf(Schema.of(Schema.Type.STRING))),
                           Schema.Field.of("mediaReadLink", Schema.nullableOf(Schema.of(Schema.Type.STRING))),
                           Schema.Field.of("mediaEditLink", Schema.nullableOf(Schema.of(Schema.Type.STRING))));
  }
  ...
  private Schema collectionSchema(PropertyMetadata propertyMetadata) {
    return Schema.recordOf(propertyMetadata.getName() + "-collection-record",
                           Schema.Field.of(SapODataConstants.GEOSPATIAL_TYPE_FIELD_NAME, Schema.of(Schema.Type.STRING)),
                           Schema.Field.of("points", Schema.arrayOf(pointSchema(propertyMetadata))),
                           Schema.Field.of("lineStrings", Schema.arrayOf(lineStringSchema(propertyMetadata))),
                           Schema.Field.of("polygons", Schema.arrayOf(polygonSchema(propertyMetadata))),
                           Schema.Field.of("multiPoints", Schema.arrayOf(polygonSchema(propertyMetadata))),
                           Schema.Field.of("multiLineStrings", Schema.arrayOf(polygonSchema(propertyMetadata))),
                           Schema.Field.of("multiPolygons", Schema.arrayOf(polygonSchema(propertyMetadata)))
